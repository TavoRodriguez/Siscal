...
<div class="container">
    ...
    $consulta = "SELECT * FROM users order by `periodicity` ASC";
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <a type="button" class="btn btn-success" href="crud/excel.php">Descargar Excel</a>
            </div>
        </div>
    </div>
    <br>
                    ...
                    <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        <thead class="text-center">
                            <tr style="background-color: black; color: white">
                                ...
                                <th class="acciones" >Día de Pago</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color: black">
                                    ...
                                    <td class="acciones"><?php echo $dat['id_day'] ?></td>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="interest_payment" step="0.01">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" aria-label="Default select example" id="periodicity" disabled>
                                        <option selected> Seleccione una opcion</option>
                                        <option value="1.Semanal">Semanal</option>
                                        <option value="2.Bisemanal">Bisemanal</option>
                                        <option value="3.Quincena">Quincena</option>
                                        <option value="4.Quincenal">Quincenal</option>
                                        <option value="5.Mensual">Mensual</option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" aria-label="Default select example" id="id_day" disabled>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" id="date" name="event_date" placeholder="YYYY-MM-DD" autocomplete="off" disabled>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
