...
<body>
    ...
    <div class="d-flex justify-content-center align-items-center login-container">
        <form id="formRegister" class="login-form text-center" action="php/restore.php" method="post">
            ...
            <button type="submit" name="submit" class="btn mt-5 rounded-pill btn-lg btn-custom btn-block text-uppercase">Enviar Correo</button>
        </form>
