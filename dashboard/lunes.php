...
<div class="container">
    ...
    $consulta = "SELECT * FROM users WHere id_day = '1' order by `periodicity` ASC";
                    ...
                    <table id="tablaPersonas" class="table table-striped table-bordered table-condensed" style="width:100%">
                        <thead class="text-center">
                            <tr style="background-color: black; color: white">
                                ...
                                <th class="order-by-desc">Periodicidad</th>
                                <th class="acciones">Tipo de pago</th>
                                <th class="acciones" hidden>Día de Pago</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr style="color: black">
                                    ...
                                    <td class="acciones" hidden><?php echo $dat['id_day'] ?></td>
