...
<div class="container">
    ...
    $consulta = "SELECT * FROM users WHere id_day = '5' order by `periodicity` ASC";
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="amount" step="0.0001">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="interest_payment" step="0.0001">
                                </div>
                            </div>
